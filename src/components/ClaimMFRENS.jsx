...
const ClaimMFRENS = () => {
  return (
    ...
    >
      ...
      >
        You can claim MFRENS now!
      </h1>

      {/* Description */}
      <div className="max-w-3xl text-center text-white space-y-4 font-semibold text-xl sm:text-2xl mb-[2.5rem]">
        <p
          style={{
            color: '#fff',
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
        <button className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-[8rem] rounded-[16px] shadow-md transition duration-200">
          Claim Airdrop
        </button>
        <button className="bg-yellow-300 hover:bg-yellow-400 text-purple-900 font-bold py-2 px-[8rem] rounded-[16px] shadow-md transition duration-200">
          Invite Friends
        </button>
      </div>
    </div>
